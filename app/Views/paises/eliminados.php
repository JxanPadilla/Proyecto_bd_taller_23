            ...
            <?php foreach ($datos as $dato) { ?>
              <tr>
                ...
                <td><?php echo $dato['estado']; ?></td>
                 ...
                 <td><button type="button" class="btn btn-secondary"  href="#" data-href="<?php echo base_url('/paises/eliminar') . '/' .$dato['id']. '/' .'A'; ?>"  data-bs-toggle="modal" data-bs-target="#modal-confirma">Activar</button></td>

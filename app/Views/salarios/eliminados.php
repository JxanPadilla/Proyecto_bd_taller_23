...
<body style="margin-top: 245px;">
  ...
  <div class="card" style="width:72rem;">
    <div>
      <h1 class="titulo" style="position: relative; top: 10px; font-family: Georgia, serif; font-style: normal; font-size: 55px; text-align: center; color: #C40000; text-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">Salarios Eliminados</h1>
    </div>
    <div class="card-body">
            ...
            <?php foreach ($salarios as $dato) { ?>
              <tr>
                ...
                <td><?php echo $dato['estado']; ?></td>
                 ...
                 <td><button type="button" class="btn btn-secondary"  href="#" data-href="<?php echo base_url('/salarios/eliminar') . '/' .$dato['id']. '/' .'A'; ?>"  data-bs-toggle="modal" data-bs-target="#modal-confirma">Activar</button></td>
...
<script>
  ...
  //     $("#id").val(id);
  //     dataURL = "<?php echo base_url('elimina_Salarios'); ?>" + "/" + id + "/" + 'A';
  //     $.ajax({
  //       type: "POST",
  //       url: dataURL,
  //       dataType: "json",
